...
model_path = r'C:\Users\arfan\OneDrive\Desktop\Sem 6\CSP650\Results n Finding\CNN\7 by 3 split\Epoch 50\CNN_Epoch50_(7.3).h5'
...
class ui_digit_recognition():
    ...
    def predict_the_value(self):
        ...
        final_val = arabic_characters[np.argmax(predected_label)]
        print(final_val)
        self.label = Label(app,text="Predicted Letter: {}"+final_val, font=('Helvetica bold', 18),fg="#023047")
